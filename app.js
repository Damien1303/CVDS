...
crearBarra(windows);
let windowsServeur = document.getElementById("windows-serveur");
crearBarra(windowsServeur);
...
function efectoHabilidades(){
    ...
    if(distancia_skills>=300 && entro==false){
        ...
        const intervalWindows = setInterval(function () {
            pintarBarra(windows, 10, 6, intervalWindows);
        }, 100);
        const intervalWindowsServeur = setInterval(function () {
            pintarBarra(windowsServeur, 10, 7, intervalWindowsServeur);
        }, 100);
    }
}
